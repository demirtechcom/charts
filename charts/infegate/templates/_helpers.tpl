...
{{- if ge (add (int .Values.api.connectionDrain.minSeconds) (int .Values.api.connectionDrain.maxSeconds)) (int .Values.api.terminationGracePeriodSeconds) }}{{ fail "api.connectionDrain.minSeconds plus maxSeconds must be less than api.terminationGracePeriodSeconds, or Kubernetes sends SIGKILL before the drain finishes" }}{{ end }}
